/*
 	Ã�â€˜Ã�Â°Ã�Â·Ã�Â¾Ã�Â²Ã‘â€¹Ã�Â¹ Ã�ÂºÃ�Â¾Ã�Â´ Ã�Â¾Ã‘â€š Espressif
 	Ã�ËœÃ�Â¼Ã�ÂµÃ�Â½Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½ Ã�Â¸ Ã�Â´Ã�Â¾Ã�Â±Ã�Â°Ã�Â²Ã�Â»Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½: 	pvvx
*/
...
static uint32_t dhcps_lease_flag = true;
static list_node *plist = NULL;
static uint8 offer = 0xFF;
static uint32 renew = false;
#define DHCPS_LEASE_TIME_DEF	(120)
uint32 dhcps_lease_time = DHCPS_LEASE_TIME_DEF;  //minute -> init in dhcps_start()
/******************************************************************************
...
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¢Ã¯Â¿Â½Ã¡Â¹Â¹Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @param optptr -- DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¢ÃŽÂ»Ã¯Â¿Â½Ã¯Â¿Â½
 * @param type -- Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã“ÂµÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½option
 *
 * @return uint8_t* Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ†Â«Ã¯Â¿Â½Ã†ÂµÃ¯Â¿Â½Ã–Â·
 */
///////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¡Â¹Â¹Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½offerÃ“Â¦Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @param optptr -- DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¢ÃŽÂ»Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @return uint8_t* Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ†Â«Ã¯Â¿Â½Ã†ÂµÃ¯Â¿Â½Ã–Â·
...
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¡Â¹Â¹Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã“Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã–Â¾Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @param optptr -- DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¢ÃŽÂ»Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @return uint8_t* Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ†Â«Ã¯Â¿Â½Ã†ÂµÃ¯Â¿Â½Ã–Â·
...
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’Â»Ã¯Â¿Â½Ã¯Â¿Â½OFFER
 *
 * @param -- m Ã–Â¸Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�ÂµÃ¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 */
///////////////////////////////////////////////////////////////////////////////////
static void ICACHE_FLASH_ATTR send_offer(struct dhcps_msg *m)
{
...
#if DHCPS_DEBUG
		LOG_I("udhcp: send_offer>>p->ref = %d", p->ref);
#endif
	    if(p != NULL){
	       
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_offer>>pbuf_alloc succeed");
	        LOG_I("dhcps: send_offer>>p->tot_len = %d", p->tot_len);
	        LOG_I("dhcps: send_offer>>p->len = %d", p->len);
#endif
	        q = p;
	        while(q != NULL){
	            data = (u8_t *)q->payload;
...
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_offer>>pbuf_alloc failed");
#endif
	        return;
	    }
#if DHCPS_DEBUG
	    ...
	    if(p->ref != 0){	
#if DHCPS_DEBUG
	        LOG_I("udhcp: send_offer>>free pbuf");
#endif
	        pbuf_free(p);
	    }
}
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’Â»Ã¯Â¿Â½Ã¯Â¿Â½NAKÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¢
 *
 * @param m Ã–Â¸Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�ÂµÃ¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 */
///////////////////////////////////////////////////////////////////////////////////
static void ICACHE_FLASH_ATTR send_nak(struct dhcps_msg *m)
{
	    ...
	    p = pbuf_alloc(PBUF_TRANSPORT, sizeof(struct dhcps_msg), PBUF_RAM);
#if DHCPS_DEBUG
		LOG_I("udhcp: send_nak>>p->ref = %d", p->ref);
#endif
	    if(p != NULL){
	        
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_nak>>pbuf_alloc succeed");
	        LOG_I("dhcps: send_nak>>p->tot_len = %d", p->tot_len);
	        LOG_I("dhcps: send_nak>>p->len = %d", p->len);
#endif
	        q = p;
	        while(q != NULL){
	            data = (u8_t *)q->payload;
...
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_nak>>pbuf_alloc failed");
#endif
	        return;
    	}
#if DHCPS_DEBUG
		err_t SendNak_err_t = udp_sendto( pcb_dhcps, p, &broadcast_dhcps, DHCPS_CLIENT_PORT );
        LOG_I("dhcps: send_nak>>udp_sendto result %x",SendNak_err_t);
#else
        udp_sendto( pcb_dhcps, p, &broadcast_dhcps, DHCPS_CLIENT_PORT );
#endif
 	    if(p->ref != 0){
#if DHCPS_DEBUG			
	        LOG_I("udhcp: send_nak>>free pbuf");
#endif
	        pbuf_free(p);
	    }
}
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’Â»Ã¯Â¿Â½Ã¯Â¿Â½ACKÃ¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @param m Ã–Â¸Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�ÂµÃ¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 */
///////////////////////////////////////////////////////////////////////////////////
static void ICACHE_FLASH_ATTR send_ack(struct dhcps_msg *m)
{
	    ...
	    p = pbuf_alloc(PBUF_TRANSPORT, sizeof(struct dhcps_msg), PBUF_RAM);
#if DHCPS_DEBUG
		LOG_I("udhcp: send_ack>>p->ref = %d", p->ref);
#endif
	    if(p != NULL){
	        
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_ack>>pbuf_alloc succeed");
	        LOG_I("dhcps: send_ack>>p->tot_len = %d", p->tot_len);
	        LOG_I("dhcps: send_ack>>p->len = %d", p->len);
#endif
	        q = p;
	        while(q != NULL){
	            data = (u8_t *)q->payload;
...
#if DHCPS_DEBUG
	        LOG_I("dhcps: send_ack>>pbuf_alloc failed");
#endif
	        return;
	    }
#if DHCPS_DEBUG
		err_t SendAck_err_t = udp_sendto( pcb_dhcps, p, &broadcast_dhcps, DHCPS_CLIENT_PORT );
		LOG_I("dhcps: send_ack>>udp_sendto result %x",SendAck_err_t);
#else
		udp_sendto( pcb_dhcps, p, &broadcast_dhcps, DHCPS_CLIENT_PORT );
#endif
	    if(p->ref != 0){
#if DHCPS_DEBUG
	        LOG_I("udhcp: send_ack>>free pbuf");
#endif
	        pbuf_free(p);
	    }
}
///////////////////////////////////////////////////////////////////////////////////
/*
 * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã‹Â·Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â¢Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã”Â²Ã¯Â¿Â½Ã�Â¬Ã¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã“Â¦Ã¯Â¿Â½Ã¯Â¿Â½Ã“Â¦Ã¯Â¿Â½Ã¯Â¿Â½
 *
 * @param optptr DHCP msgÃ¯Â¿Â½Ã�ÂµÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 * @param len Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã„Â´Ã¯Â¿Â½Ã¯Â¿Â½?(byte)
 *
 * @return uint8_t Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã˜Â´Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCP ServerÃ—Â´ÃŒÂ¬Ã–Âµ
 */
///////////////////////////////////////////////////////////////////////////////////
static uint8_t ICACHE_FLASH_ATTR parse_options(uint8_t *optptr, sint16_t len)
{
        ...
        client.addr = *( (uint32_t *) &client_address);// Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã‹ÂµÃ¯Â¿Â½IP
        ...
        while (optptr < end) {
#if DHCPS_DEBUG
        	LOG_I("dhcps: (sint16_t)*optptr = %d", (sint16_t)*optptr);
#endif
...
#if DHCPS_DEBUG
                    		LOG_I("dhcps: DHCP_OPTION_REQ_IPADDR = 0 ok");
#endif
                            s.state = DHCPS_STATE_ACK;
                        }else {
#if DHCPS_DEBUG
                    		LOG_I("dhcps: DHCP_OPTION_REQ_IPADDR != 0 err");
#endif
...
#if DHCPS_DEBUG
    	LOG_I("dhcps: return s.state = %d", s.state);
#endif
        return s.state;
}
///////////////////////////////////////////////////////////////////////////////////
...
#if DHCPS_DEBUG
        	LOG_I("dhcps: len = %d", len);
#endif
	        /*
         	 * Ã¯Â¿Â½Ã¯Â¿Â½Ã‚Â¼Ã¯Â¿Â½Ã¯Â¿Â½Ã‡Â°Ã¯Â¿Â½Ã¯Â¿Â½xidÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â´Â¦Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½?
         	 * Ã¯Â¿Â½Ã‹ÂºÃ¯Â¿Â½ÃŽÂªDHCPÃ¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃƒÂ»Ã¯Â¿Â½Ã�Â³Ã’Â»Ã¯Â¿Â½Ã¯Â¿Â½ÃˆÂ¡IPÃŠÂ±Ã¯Â¿Â½Ã¯Â¿Â½
         	*/
//	        if((old_xid[0] == 0) &&
//	           (old_xid[1] == 0) &&
//	           (old_xid[2] == 0) &&
//	           (old_xid[3] == 0)){
//	            /*
//	             * old_xidÃŽÂ´Ã¯Â¿Â½Ã¯Â¿Â½Ã‚Â¼Ã¯Â¿Â½ÃŽÂºÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½?
//	             * Ã¯Â¿Â½Ã�Â¶Ã¯Â¿Â½Ã¯Â¿Â½Ã‡ÂµÃ¯Â¿Â½Ã’Â»Ã¯Â¿Â½Ã¯Â¿Â½ÃŠÂ¹Ã¯Â¿Â½Ã¯Â¿Â½
//	            */
//	            os_memcpy((char *)old_xid, (char *)m->xid, sizeof(m->xid));
//	        }else{
//	            /*
//	             * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃŽÂ´Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½DHCP msgÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¯Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½xidÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â´ÃŽÂ¼Ã¯Â¿Â½Ã‚Â¼Ã¯Â¿Â½Ã„Â²Ã¯Â¿Â½Ã�Â¬Ã¯Â¿Â½Ã¯Â¿Â½
//	             * Ã¯Â¿Â½Ã�Â¶Ã¯Â¿Â½ÃŽÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã�Â¬Ã¯Â¿Â½Ã¯Â¿Â½DHCPÃ¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã‹Â·Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â£Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃŠÂ±Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã„Â¿Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½IP
//	             * Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ 192.168.4.100(0x6404A8C0) <--> 192.168.4.200(0xC804A8C0)
//	             *
//	            */
//	            if(os_memcmp((char *)old_xid, (char *)m->xid, sizeof(m->xid)) != 0){
	                /*
                 	 * Ã¯Â¿Â½Ã¯Â¿Â½Ã‚Â¼Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃŽÂµÃ¯Â¿Â½xidÃ¯Â¿Â½Ã…Â£Ã¯Â¿Â½Ã�Â¬ÃŠÂ±Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½IPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
                 	*/
...
#if DHCPS_DEBUG
								LOG_I("the same device request ip");
#endif
...
//									client_address.addr = client_address_plus.addr;
#if DHCPS_DEBUG
								LOG_I("the ip addr has been request");
#endif
								/*								addr_tmp.addr = htonl(client_address_plus.addr);
								addr_tmp.addr++;
								client_address_plus.addr = htonl(addr_tmp.addr);
...
/*                                addr_tmp.addr = htonl(client_address.addr);
						...
						if ((client_address.addr > dhcps_lease.end_ip.addr) || (client_address.addr == IPADDR_ANY)){
                            LOG_I("client_address_plus.addr %x %d", client_address_plus.addr, system_get_free_heap_size());
						    if(pnode != NULL) {
...
#if DHCPS_DEBUG
	                LOG_I("dhcps: xid changed");
	                LOG_I("dhcps: client_address.addr = %x", client_address.addr);
#endif
...
///////////////////////////////////////////////////////////////////////////////////
/*
 * DHCP Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â°Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã•Â´Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã˜ÂµÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã‹ÂºÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½LWIP UDPÃ„Â£Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½ÃŠÂ±Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
 * Ã¯Â¿Â½Ã¯Â¿Â½Ã’ÂªÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½udp_recv()Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½LWIPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã—Â¢Ã¯Â¿Â½Ã¯Â¿Â½.
 *
 * @param arg
 * @param pcb Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã•ÂµÃ¯Â¿Â½UDPÃ¯Â¿Â½Ã¯Â¿Â½Ã„Â¿Ã¯Â¿Â½Ã¯Â¿Â½Ã†Â¿Ã¯Â¿Â½?
 * @param p Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã•ÂµÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½UDPÃ¯Â¿Â½Ã�ÂµÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½?
 * @param addr Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â´Ã¯Â¿Â½UDPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã”Â´Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½IPÃ¯Â¿Â½Ã¯Â¿Â½Ã–Â·
 * @param port Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â´Ã¯Â¿Â½UDPÃ¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã”Â´Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½UDPÃ�Â¨Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã‹Â¿ÃšÂºÃ¯Â¿Â½
 */
///////////////////////////////////////////////////////////////////////////////////
									...
									uint16_t port)
{
...
#if DHCPS_DEBUG
    	LOG_I("dhcps: handle_dhcp-> receive a packet");
#endif
	    if (p==NULL) return;
...
#if DHCPS_DEBUG
	    LOG_I("dhcps: handle_dhcp-> p->tot_len = %d", tlen);
	    LOG_I("dhcps: handle_dhcp-> p->len = %d", p->len);
#endif		
		...
		if(p->next != NULL) {
#if DHCPS_DEBUG
	        LOG_I("dhcps: handle_dhcp-> p->next != NULL");
	        LOG_I("dhcps: handle_dhcp-> p->next->tot_len = %d",p->next->tot_len);
	        LOG_I("dhcps: handle_dhcp-> p->next->len = %d",p->next->len);
#endif
		...
		/*
	     * DHCP Ã¯Â¿Â½Ã�Â»Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã�Â¢Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½Ã¯Â¿Â½
	    */
#if DHCPS_DEBUG
    	LOG_I("dhcps: handle_dhcp-> parse_msg(p)");
#endif
...
#if DHCPS_DEBUG            
            	 LOG_I("dhcps: handle_dhcp-> DHCPD_STATE_OFFER");
#endif			
	             send_offer(pmsg_dhcps);
	             break;
	        case DHCPS_STATE_ACK: //3
#if DHCPS_DEBUG
            	 LOG_I("dhcps: handle_dhcp-> DHCPD_STATE_ACK");
#endif			
	             send_ack(pmsg_dhcps);
	             break;
	        case DHCPS_STATE_NAK: //4
#if DHCPS_DEBUG            
            	 LOG_I("dhcps: handle_dhcp-> DHCPD_STATE_NAK");
#endif
	             send_nak(pmsg_dhcps);
	             break;
			default :
...
#if DHCPS_DEBUG
    	LOG_I("dhcps: handle_dhcp-> pbuf_free(p)");
#endif
        pbuf_free(p);
        os_free(pmsg_dhcps);
        pmsg_dhcps = NULL;
...
static void ICACHE_FLASH_ATTR wifi_softap_init_dhcps_lease(uint32 ip)
{
	...
	if (dhcps_lease_flag == TRUE) { // Ã�Â¿Ã‘â‚¬Ã�Â¾Ã�Â²Ã�ÂµÃ‘â‚¬Ã�ÂºÃ�Â°
		if(softap_ip != (dhcps_lease.start_ip.addr & ((1 << 24) - 1))
		 ...
		 ||(ip >= dhcps_lease.start_ip.addr && ip <= dhcps_lease.end_ip.addr)) // Ã�Â¿Ã�Â¾Ã�Â¿Ã�Â°Ã�Â´Ã�Â°Ã�ÂµÃ‘â€š Ã�Â² Ã�Â´Ã�Â¸Ã�Â°Ã�Â¿Ã�Â°Ã�Â·Ã�Â¾Ã�Â½
			dhcps_lease_flag = FALSE;
	}
	if (dhcps_lease_flag == FALSE) { // dhcps_lease Ã�Â½Ã�Âµ Ã�Â·Ã�Â°Ã�Â´Ã�Â°Ã�Â²Ã�Â°Ã�Â»Ã�Â°Ã‘ï¿½Ã‘Å’ -> Ã�Â°Ã�Â²Ã‘â€šÃ�Â¾Ã�Â¼Ã�Â°Ã‘â€šÃ�Â¸Ã‘â€¡Ã�ÂµÃ‘ï¿½Ã�ÂºÃ�Â°Ã‘ï¿½ Ã‘Æ’Ã‘ï¿½Ã‘â€šÃ�Â°Ã�Â½Ã�Â¾Ã�Â²Ã�ÂºÃ�Â°
...
#if DHCPS_DEBUG
	LOG_I("start_ip = 0x%x, end_ip = 0x%x, enable=%u",dhcps_lease.start_ip, dhcps_lease.end_ip, dhcps_lease_flag);
#endif
}
///////////////////////////////////////////////////////////////////////////////////
void ICACHE_FLASH_ATTR dhcps_start(struct ip_info *info)
{
	...
	if (pcb_dhcps == NULL || info ==NULL) {
		LOG_I("dhcps_start(): could not obtain pcb");
	}
...
#if DHCPS_DEBUG
	LOG_I("dhcps:dhcps_start->udp_recv function Set a receive callback handle_dhcp for UDP_PCB pcb_dhcps");
#endif
