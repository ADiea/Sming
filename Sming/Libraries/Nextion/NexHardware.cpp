...
SoftwareSerial *nexSerial = nullptr;
...
__return:
    ...
    if (ret) 
    {
        dbSerialPrint("recvRetNumber :%d", *number);
    }
    else
    {
...
__return:
    ...
    dbSerialPrint("recvRetString[%d,%s]", temp.length(), temp);
...
{    
    ...
    if (ret) 
    {
        dbSerialPrint("recvRetCommandFinished ok");
    }
    else
    {
